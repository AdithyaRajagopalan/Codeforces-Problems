...
int main() {
    //Accepting number of actions to be performed.
    int numOfInputs;
    std::cin>>numOfInputs;
    int x = 0;
    std::string inpOperation;
    //We need to only check middle value of the three-character string input given.
    //If middle character is +, then increment x. Else decrement x.
    //Accept input for operations to perform.
